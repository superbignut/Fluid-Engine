...
struct VectorParticleData3 FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<const big::fbs::Vector3D *> *data() const {
    return GetPointer<const ::flatbuffers::Vector<const big::fbs::Vector3D *> *>(VT_DATA);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_DATA) &&
...
struct VectorParticleData3Builder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_data(::flatbuffers::Offset<::flatbuffers::Vector<const big::fbs::Vector3D *>> data) {
...
inline ::flatbuffers::Offset<VectorParticleData3> CreateVectorParticleData3(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::Vector<const big::fbs::Vector3D *>> data = 0) {
...
inline ::flatbuffers::Offset<VectorParticleData3> CreateVectorParticleData3Direct(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<big::fbs::Vector3D> *data = nullptr) {
  auto data__ = data ? _fbb.CreateVectorOfStructs<big::fbs::Vector3D>(*data) : 0;
